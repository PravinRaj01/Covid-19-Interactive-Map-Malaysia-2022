...
custom_css <- tags$head(
  tags$style(HTML("
    /* Professional Classy UI Styles - Using Bootstrap CSS Variables for Dark Mode */
    body {
      font-family: 'Segoe UI', -apple-system, BlinkMacSystemFont, 'Helvetica Neue', Arial, sans-serif;
      background: var(--bs-body-bg, #f5f7fa);
      min-height: 100vh;
    ...
    .main-header {
      ...
      border-bottom: 3px solid var(--bs-primary, #2c5282);
    }
    ...
    .control-card {
      background: var(--bs-secondary-bg, #f7fafc);
      border-radius: 6px;
      padding: 20px;
      margin-bottom: 20px;
    ...
    .date-input-wrapper input:focus {
      ...
      outline: none;
      box-shadow: 0 0 0 3px rgba(var(--bs-primary-rgb, 44, 82, 130), 0.1);
    }
    
    .selected-date-display {
      background: var(--bs-secondary-bg, #edf2f7);
      padding: 10px 12px;
      border-radius: 4px;
      font-size: 13px;
      color: var(--bs-body-color, #2d3748);
      margin-top: 12px;
      border-left: 3px solid var(--bs-primary, #2c5282);
    }
    ...
    .btn-refresh:hover {
      background: var(--bs-primary-hover, #2a4365);
    ...
    .link-section a {
      color: var(--bs-link-color, #2c5282);
    ...
    .link-section a:hover {
      color: var(--bs-link-hover-color, #2a4365);
    ...
    .nav-tabs > li > a:hover {
      ...
      border-bottom-color: var(--bs-border-color, #cbd5e0);
    }
    ...
    .nav-tabs > li.active > a {
      ...
      color: var(--bs-primary, #2c5282);
      border-color: transparent;
      border-bottom-color: var(--bs-primary, #2c5282);
      font-weight: 600;
    }
    ...
    .shiny-notification {
      ...
      border-left: 4px solid var(--bs-primary, #2c5282);
    }
  "))
)
...
ui <- fluidPage(
  theme = bslib::bs_theme(preset = "shiny"),  # shiny preset works best with dark mode
  custom_css,
